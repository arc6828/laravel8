<x-bootstrap title="รายการใบเสนอราคา">
    <div class="card">
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($row->sales_status_id == 1)
                                        ...
                                        <span
                                            class="badge badge-pill badge-primary">{{ $row->sales_status_name }}</span>
                                    @elseif($row->sales_status_id == 4)
                                        <span
                                            class="badge badge-pill badge-danger">{{ $row->sales_status_name }}</span>
                                    @elseif($row->sales_status_id == 5)
                                        <span
                                            class="badge badge-pill badge-success">{{ $row->sales_status_name }}</span>
                                    @elseif($row->sales_status_id == -1)
                                        <span
                                            class="badge badge-pill badge-secondary">{{ $row->sales_status_name }}</span>
                                    @else
                                        <span
                                            class="badge badge-pill badge-warning">{{ $row->sales_status_name }}</span>
                                    @endif
                                </td>
                                <td class="d-none">
