                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row ">
                                                    <div class="col-sm-3">
                                                        <input wire:model="priceMin" type="number" name="priceMin" min="0"
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input wire:model="priceMax" type="number" name="priceMax" min="0"
                                                            class="form-control" required />
                                                    </div>
                                                </div>
                                                <br />
                                                    ...
                                                    @foreach ($category as $c)
                                                        <div class="col-sm-4">
                                                            <div class="form-check">
                                                                <input wire:model="category_ids"
                                                                    class="form-check-input" type="checkbox"
                                                                    value="{{ $c->id }}" name="category_ids[]">
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/movie' . '/' . $item->id) }}"
                                                ...
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                    title="Delete Movie" onclick="return confirm('Confirm delete?')"><i
